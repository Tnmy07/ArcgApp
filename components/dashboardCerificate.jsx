...
// import { MYCERTIFICATEPAGE } from "../../constants/router";
...
export const DashboardCertificate = () => {
  ...
  const fetchInfo = async () => {
    ...
    Axios({
      method: 'GET',
      url: 'https://dgificate.in/api/v1/my-certificate/dashboard',
      headers: {
  ...
  console.log("tnmy", certificatenotFound)
  ...
  return (
    <>
      ...
      <View style={styles.row_tab_content_wrapper}>
        <Link style={styles.link_text} href={MYCERTIFICATEPAGE}><Text style={styles.tab_headings_text}>My Certificate</Text> </Link>

...
import { TRANSFEREDCERTIFICATE } from "../constants/router";



export const TransferedCertificate = () => {
      ...
      <View style={styles.tab_content}>
        <>
          <View style={styles.row_tab_content_wrapper}>
            {/* <Text style={styles.tab_headings_text}>Transfered Certificate</Text> */}
            <Link style={styles.link_text} href={TRANSFEREDCERTIFICATE}><Text style={styles.tab_headings_text}>Transfered Certificate</Text> </Link>

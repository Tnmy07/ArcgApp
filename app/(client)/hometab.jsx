            ...
            {useTabName === "dnacertificate" && (
              <>
                {/* <View style={styles.row_tab_content_wrapper}>
                  <View style={styles.row_heading_item}>
                    <Image style={styles.img_ic} source={require("../../assets/images/ic1.png")} />
                    <Text style={styles.tab_headings_text}>My Certificates</Text>
                  </View>
                  <View style={styles.tab_content_wrapper_item}>
                    {[1, 2, 3, 4, 5, 6].map((item) => (
                      <View key={item} style={styles.item_wrap_avater_card}>
                        <View style={styles.pos_item_round}>
                          <Text style={styles.pos_item_round_text}>1</Text>
                        </View>
                        <Image
                          source={require("../../assets/images/card.png")}
                          style={styles.itm_avatar_card}
                        />
                      </View>
                    ))}
                  </View>
                        ...
                        <View style={styles.row_data_cover}>
                          <View style={styles.row_text_item}>
                            <View style={styles.row_data_item}>
                              ...
                              <Text style={styles.lst_text_two}>1234</Text>
                            </View>
                            <View style={styles.row_data_item}>
                              <Text style={styles.fst_text_tow}>Species:</Text>
                              <Text style={styles.lst_text_two}>African Lovebird</Text>
                            </View>
                            <View style={styles.row_data_item}>
                              <Text style={styles.fst_text_tow}>Mutation:</Text>
                              <Text style={styles.lst_text_two}>Lutino Fischer's</Text>
                            </View>
                            <View style={styles.row_data_item}>
                              <Text style={styles.fst_text_tow}>Lab ID:</Text>
                              <Text style={styles.lst_text_two}>Ajfg1245</Text>
                            </View>
                          </View>
                        </View>
                        <View style={styles.row_data_item_center_two}>
                          <Text style={styles.fst_text_center_two}>Result:</Text>
                          <Text style={styles.lst_text_center_two}>Male/Female</Text>
                          <View style={styles.itm_round_two}></View>
                        </View>
                      </View>
                    ))}
                ...
                {/* <View style={styles.row_tab_content_wrapper}>
                  <View style={styles.row_heading_item}>
                    <Image style={styles.img_ic} source={require("../../assets/images/ic2.png")} />
